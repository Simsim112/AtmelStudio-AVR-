...
#if	LCD == 8
#define	LCD_DATAWR	PORTD	//LCD 데이터버스 정의(데이터 쓰기)
#define LCD_INSTWR	PORTD	//LCD 데이터버스 정의(명령어 쓰기)
#define	LCD_CTRL	PORTG	//LCD 제어신호 정의
#endif

#define	LCD_EN	1			//Enable 신호 정의
#define LCD_RW	2			//Write(0), Read(1)
#define LCD_RS	3			//Select 신호정의 : IR(0), DR(1)
